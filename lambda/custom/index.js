...
const SalaryHandler = {
  ...
  handle(handlerInput) {
    ...
    var question = askQuestion(handlerInput);
    randomResponses = [
      'We spoke with the team, and we would love to have you on board. Here are the details of your offer: $75k base, $30k RSUs (over 4 years) and $10k sign on bonus. <break time="10s"/><break time="10s"/> Sample Response: Hey I am really excited about the team, loved meeting everyone. In terms of total comp, I"m looking for something closer to 150K. Would you be open to a base of $100k?',
